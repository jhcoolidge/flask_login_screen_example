...
def get_error_report(errors, file_dataframe):
    ...
    for error_index, error in enumerate(errors):
        ...
        found_error_records = file_dataframe[file_dataframe.isin([error_value]).any(axis=1)].values #This needs to be able to work with json and doesnt find null errors
            ...
            if filename.endswith('.json') or filename.endswith('.csv'):
                ...
                if filename.endswith('.json'):
                    try:
                        ...
                        format=bigquery.SourceFormat.NEWLINE_DELIMITED_JSON
                    except:
                        empty = True
                ...
                #this will only run if the file is a csv
                    ...
                    try:
                        ...
                        format=bigquery.SourceFormat.CSV
                    except:
                        empty = True
